...
export default function GuidingPillar({
  ...
  return (
    <AnimationControlContext.Provider value={animationControlRef.current}>
      <div
        ref={pillarRef}
        className="group relative flex w-[80vw] max-w-[50rem] flex-col items-center justify-center rounded-lg bg-white transition-all duration-300 ease-out sm:flex-row sm:even:flex-row-reverse xl:w-80 xl:flex-col xl:even:flex-col"
      >
